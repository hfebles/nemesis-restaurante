...
class ProductCategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $save->save();
        return redirect()->route('category.index')->with('message', 'La categoría ' . $save->name_product_category . ' se registró con éxito');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('category.index')->with('message', 'La categoría ' . $data['name_product_category'] . ' se edito con éxito');
    }
}
