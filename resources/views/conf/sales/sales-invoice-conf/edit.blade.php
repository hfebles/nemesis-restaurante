...
@section('content')
    {!! Form::model($data, [
        ...
        'method' => 'PATCH',
        'route' => ['invoices-config.update', $data->id_invoicing_configutarion],
    ]) !!}
    <div class="row">
        <x-cards>
            <table class="table table-bordered table-sm">
                <tr>
                    <td>Correlativo:</td>
                    <td>{!! Form::text('correlative_invoicing_configutarion', null, [
                        'id' => 'correlative_invoicing_configutarion',
                        'autocomplete' => 'off',
                        'required',
                ...
                <tr>
                    ...
                    <td>{!! Form::text('print_name_invoicing_configutarion', null, [
                        'id' => 'print_name_invoicing_configutarion',
                        'autocomplete' => 'off',
                        'required',
                        'class' => 'form-control form-control-sm',
                    ]) !!}</td>
                ...
                <tr>
                    ...
                    <td>{!! Form::text('control_number_invoicing_configutarion', null, [
                        'id' => 'control_number_invoicing_configutarion',
                        'autocomplete' => 'off',
                        'required',
                        'class' => 'form-control form-control-sm',
                    ]) !!}</td>
