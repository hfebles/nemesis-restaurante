    ...
    <div class="row">
        <x-cards>
            ...
            <table class="table table-sm table-bordered">
                <tr>
                    <th width="75%" scope="col" class="text-end align-middle">BASE IMPONIBLE: </th>
                    <td class="text-end align-middle">
                        <p class='align-middle mb-0' id="subFacs"></p><input type="hidden" id="subFac" name="subFac">
                    </td>
                </tr>
                <tr>
                    <th width="75%" scope="col" class="text-end align-middle">EXENTO: </th>
                    <td class="text-end align-middle">
                ...
                @foreach ($taxes as $tax)
                    <tr>
                        ...
                        @else
                            <td width="10%" class="text-end align-middle">
                                <p class='align-middle mb-0' id="IGTFs"><input onkeyup="calculate(0, this.value)"
                                        class="form-control" autocomplete="off" id="amount_igtf" type="number"
                                        name="amount_igtf">
                            </td>
                            <td class="text-end align-middle">
                                <p class='align-middle mb-0' id="IGTFs"></p><input type="hidden" id="IGTF"
                                    name="IGTF">
                            </td>
                        @endif
                    </tr>
                ...
                <tr>
                    <th width="75%" scope="col" class="text-end align-middle">TOTAL: </th>
                    <td class="text-end align-middle">
