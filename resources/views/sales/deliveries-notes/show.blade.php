                    ...
                    <table class="table table-sm table-bordered">
                        <tr>
                            ...
                            <td width="10%" class="text-start">
                                <span id="razon_social">{{ date('d-m-Y', strtotime($data->date_delivery_note)) }}</span>
                            </td>
                        </tr>
                        <tr>
                            <td class="text-end">Nro control:</td>
                            <td class="text-start">
                                <span id="razon_social">{{ $data->ref_name_delivery_note }}</span>
                            </td>
                        </tr>
                    </table>
                        ...
                        <tr>
                            ...
                            <th scope="col" class="text-end align-middle">
                                <p class='align-middle mb-0' id="subFacs">$
                                    {{ number_format($data->no_exempt_amout_delivery_note / $data->amount_exchange, 2, ',', '.') }}
                                </p>
                            </th>
                            ...
                            <th scope="col" class="text-end align-middle">
                                <p class='align-middle mb-0' id="subFacs">Bs.
                                    {{ number_format($data->no_exempt_amout_delivery_note, 2, ',', '.') }}</p>
                            </th>
                        </tr>
                        <tr>
                            ...
                            <th scope="col" class="text-end align-middle">
                                ...
                                {{ number_format($data->exempt_amout_delivery_note, 2, ',', '.') }}
                            </th>
                        </tr>
                        <tr>
                            ...
                            <th scope="col" class="text-end align-middle">
                                <p class='align-middle mb-0' id="subFacs">$
                                    {{ number_format($data->total_amount_tax_delivery_note / $data->amount_exchange, 2, ',', '.') }}
                                </p>
                            </th>
                            ...
                            <th scope="col" class="text-end align-middle">
                                <p class='align-middle mb-0' id="totalIVaas">Bs.
                                    {{ number_format($data->total_amount_tax_delivery_note, 2, ',', '.') }}</p>
                            </th>
                        </tr>
                        <tr>
                            ...
                            <th scope="col" class="text-end align-middle">
                                <p class='align-middle mb-0' id="totalTotals">Bs.
                                    {{ number_format($data->total_amount_delivery_note, 2, ',', '.') }}</p>
                            </th>
                        </tr>
                                ...
                                @foreach ($surplus as $k => $plus)
                                    <tr>
                                        <td colspan="4" class="text-end fst-italic text-muted text-end"><a
                                                href="{{ route('payments.register-pay-sur', [$plus->id_payment, $data->id_delivery_note, 2]) }}">#{{ $plus->ref_payment }}
                                                |
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="col-sm-6">
                        <div class="form-floating">
                            {!! Form::text('residual_amount_invoicing', number_format($data->residual_amount_delivery_note, 2, ',', '.'), [
                                'disabled',
                    ...
                    <div class="col-sm-6">
                        <div class="form-floating">
                            {!! Form::text('amount_payment', $data->residual_amount_delivery_note, [
                    ...
                    {!! Form::hidden('id_delivery_note', $data->id_delivery_note) !!}
                    {!! Form::hidden('id_client', $data->id_client) !!}
                    {!! Form::hidden('type_pay', 2) !!}
                    {!! Form::close() !!}
